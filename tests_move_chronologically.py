...
def test_overall_program():
	...
	# python move_chronologically.py -s test_results/test_directory -d test_results/resulting_images -e .heic -m false -c false -r false
	subprocess.run([
		"python",
		"move_chronologically.py",
		"-s",
		"test_results/test_directory",
		"-d",
		"test_results/resulting_images",
		"-e",
		".heic",
		"-m",
		"false",
