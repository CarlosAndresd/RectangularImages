...
def test_overall_program_2():
	...
	subprocess.run(['python', 'move_chronologically.py', '-s', 'test_results/test_directory', '-d',
					'test_results/resulting_images', '-e', '.heic', '.jpg', '.jpeg', '-m', 'false', '-r', 'false',
					'-t' 'created', '-c', 'false', ])
	extensions_to_search = ''
	answer = set(find_all_files('test_results', copy_file_extensions=extensions_to_search))
	shutil.rmtree('test_results')
	correct_answer = {'test_results/resulting_images/2022/2022_11/file_6_1.heic',
					  ...
					  'test_results/resulting_images/2021/2021_03/file_7_1.jpg',
					  'test_results/resulting_images/2020/2020_10/file_22_1.jpg',
					  'test_results/resulting_images/2016/2016_10/file_17.jpg',
					  'test_results/resulting_images/2021/2021_03/file_7.jpg',
					  'test_results/resulting_images/2020/2020_09/file_3_1.jpg',
					  'test_results/resulting_images/2021/2021_04/file_15_2.jpg',
					  'test_results/resulting_images/2020/2020_09/file_3_2.jpg',
					  'test_results/resulting_images/2020/2020_09/file_3.jpg',
					  'test_results/resulting_images/2021/2021_04/file_15_1.jpg',
					  'test_results/resulting_images/2020/2020_03/file_19.jpg',
					  'test_results/resulting_images/2020/2020_10/file_22.jpg',
					  'test_results/resulting_images/2021/2021_04/file_15.jpg',
					  'test_results/test_directory/dir_1/dir_4/file_4.png',
					  'test_results/test_directory/dir_1/dir_4/file_13.PNG',
					  'test_results/test_directory/dir_1/dir_4/file_18.PNG',
					  'test_results/test_directory/dir_1/dir_5/file_2.png',
...
def test_overall_program_3():
	...
	subprocess.run(['python', 'move_chronologically.py', '-s', 'test_results/test_directory', '-d',
					'test_results/resulting_images', '-e', '.heic', '.jpg', '.jpeg', '-m', 'false', '-r', 'false',
					'-t' 'modified', '-c', 'false', ])
	extensions_to_search = '.heic', '.jpeg',
	answer = set(find_all_files('test_results', copy_file_extensions=extensions_to_search))
	shutil.rmtree('test_results')
	correct_answer = {'test_results/resulting_images/2022/2022_11/file_6_1.heic',
					  'test_results/resulting_images/2022/2022_11/file_14.heic',
